        ...
        <div className="relative z-10 flex flex-col justify-center items-center p-12 text-white">
          ...
          >
            <Link to="/" className="inline-flex items-center gap-2 mb-12">
              ...
              <span className="text-2xl font-bold">SWAP N MEET</span>
            </Link>
            
            <h1 className="text-4xl font-bold mb-6 leading-tight">
              {isLogin 
                ? "Welcome Back to the Community" 
                : "Join a Community of Swappers"}
            </h1>
            <p className="text-lg text-white/80 mb-8">
              {isLogin
                ? "Sign in to continue trading skills, services, and value with people in your community."
                : "Create your account and start exchanging what you have for what you need."}
            </p>
            ...
            <div className="grid grid-cols-3 gap-6 mt-12">
              ...
              <div className="text-center">
                ...
                <div className="text-sm text-white/70">Successful Swaps</div>
              </div>
              <div className="text-center">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        ...
        >
          ...
          <Link to="/" className="lg:hidden flex items-center gap-2 mb-8 justify-center">
            ...
            <span className="text-xl font-bold text-foreground">SWAP N MEET</span>
          </Link>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <Button
              type="submit"
              className="w-full h-12 bg-primary hover:bg-primary-dark text-white font-semibold rounded-xl transition-all duration-200 flex items-center justify-center gap-2 group"
            >
              {isLogin ? "Sign In" : "Create Account"}
